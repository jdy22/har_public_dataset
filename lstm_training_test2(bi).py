...
logfile = open("BiLSTM_test1.txt", "w")

# Constants/parameters
k = 5  #kernel size for av/max_pooling
...
logfile.write("Bi-LSTM no Attention (max_pooling)\n")
...
class LSTMModel(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, layer_dim, output_dim, batch_first=True, bidirectional=True, use_attention=False): 
